...
from `covid-19-analysis-450007.Covid19_deaths.deaths`
...
----cumilative death for each country in 2020
SELECT Country_Region, 
...
---total death cases globally in 2020
select 
    SUM(january + February+march+april+may+june+july+august+september+october+november+december) AS total_death_2020
from `covid-19-analysis-450007.Covid19_deaths.death_clean`

--- total deaths globally every month in 2020
...
--- countries with more than 0 deaths in january 
select Country_Region, january
from `covid-19-analysis-450007.Covid19_deaths.death_clean`
where january >0
order by january desc

--- countries with 0 deaths in decemeber
select Country_Region, december
from `covid-19-analysis-450007.Covid19_deaths.death_clean`
where december = 0
order by december desc

--- countries with 0 deaths through out 2020
select Country_Region
from `covid-19-analysis-450007.Covid19_deaths.death_clean`
...
--- average numbeer of deaths per country per month
